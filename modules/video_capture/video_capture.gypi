      ...
      'targets': [
	   ...
	   ['OS=="mac"', {
              'sources': [
                'mac/device_info.h',
                'mac/device_info.mm',
                'mac/device_info_objc.h',
                'mac/device_info_objc.mm',
                'mac/rtc_video_capture_objc.h',
                'mac/rtc_video_capture_objc.mm',
                'mac/video_capture.h',
		...
		['OS=="win"', {
              ...
              'sources': [
				...
				'windows/screen_capture_ds.cc',
                'windows/screen_capture_ds.h',
