...
VideoCaptureModule* VideoCaptureFactory::Create(const int32_t id,
  ...
  VideoCaptureModule* M= videocapturemodule::VideoCaptureImpl::Create(id, externalCapture);
LOG(LS_WARNING) << "VideoCaptureModule* VideoCaptureFactory::Create finished"; 
return M;
}
