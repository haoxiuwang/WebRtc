...
public class VideoCaptureAndroid implements PreviewCallback, Callback {
  ...
  private synchronized boolean stopCapture() {
    Log.i("mylogchat", "Java stopCapture");
    ...
    Log.i("mylogchat", "Java stopCapture done");
    return status;
  }

  private void stopCaptureOnCameraThread(
      Exchanger<Boolean> result) {
    Log.i("mylogchat", "Java stopCaptureOnCameraThread");
    if (camera == null) {
   ...
   Log.i("mylogchat", "Java camera.release();");
      camera.release();
      camera = null;
      exchange(result, true);
      Looper.myLooper().quit();
   Log.i("mylogchat", "Java return");
      return;
    } catch (IOException e) {
      error = e;
    } catch (RuntimeException e) {
   ...
   Log.i("mylogchat", "Java Failed to stop camera");
